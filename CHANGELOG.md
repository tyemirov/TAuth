...
- TA-331: Fixed SQLite DSN parsing so `sqlite://file:/absolute/path` resolves to `file:/absolute/path`, allowing Docker volume paths to open correctly with the CGO-free driver.

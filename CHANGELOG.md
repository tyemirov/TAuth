...
- TA-208: Enforced nonce issuance/validation for Google Sign-In via `/auth/nonce`, updated clients to attach `nonce_token`, and expanded tests covering mismatch and issuance failures.

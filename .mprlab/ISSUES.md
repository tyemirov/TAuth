...
- [x] [TA-447] Add the MediaOps static-frontend tenant to the TAuth-owned production registry.
  ...
  Resolved 2026-07-15: added the `mediaops` tenant, dedicated `mediaops_session`/`mediaops_refresh` cookies, Pages origin CORS, and production doctor/preflight coverage. Validation passed with `make ci`.
